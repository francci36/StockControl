            ...
            <form method="POST" action="{{ route('suppliers.storeWithProducts') }}" class="space-y-4">
                ...
                <div id="products-section">
                    ...
                    <div class="product-item flex flex-wrap items-center space-x-4">
                        ...
                        <input type="number" name="products[0][quantity]" class="form-input mt-1 flex-1 w-full sm:w-auto border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200" placeholder="Quantité initiale" min="0" value="0">
...
<script>
    document.getElementById('add-product').addEventListener('click', function () {
        ...
        newProduct.innerHTML = `
            ...
            <input type="number" name="products[${index}][quantity]" class="form-input mt-1 flex-1 w-full sm:w-auto border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200" placeholder="Quantité initiale" min="0" value="0">
